...
<div class="container mt-5 pt-5">
    ...
    <div class="row mt-2 mb-2">
        <div class="col-8">
            <a href="/mau-sac/create"><button type="button" class="btn btn-primary">Thêm</button></a>
        </div>
    ...
    <table class="table">
        ...
        <c:forEach items="${data}" var="sp">
            <tr>
                ...
                <td>
                    <a href="/mau-sac/edit/${sp.id}"><button type="button" class="btn btn-info">Sửa</button></a>
                    <a href="/mau-sac/delete/${sp.id}"><button type="button" class="btn btn-danger">Xóa</button></a>
                </td>
            </tr>

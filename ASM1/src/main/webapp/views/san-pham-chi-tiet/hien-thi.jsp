...
<div class="container mt-5 pt-5">
    ...
    <div class="row mt-2 mb-2">
        <div class="col-8">
            <a href="/san-pham-chi-tiet/create"><button type="button" class="btn btn-primary">Thêm</button></a>
        </div>
    ...
    <table class="table">
        ...
        <c:forEach items="${data}" var="ds">
            <tr>
                ...
                <td>${ds.soLuong}</td>
                <td>${ds.donGia}</td>
                <td>${ds.trangThai == 1 ? "Còn Hàng" : "Hết Hàng"}</td>
                <td>
                    <a href="/san-pham-chi-tiet/edit/${ds.id}"><button type="button" class="btn btn-info">Sửa</button></a>
                    <a href="/san-pham-chi-tiet/delete/${ds.id}"><button type="button" class="btn btn-danger">Xóa</button></a>
                </td>
            </tr>

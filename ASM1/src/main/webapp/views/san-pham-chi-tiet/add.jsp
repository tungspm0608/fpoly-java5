...
<div class="container mt-5 pt-5">
    ...
    <form action="/san-pham-chi-tiet/story" method="post">
        ...
        <div class="form-floating mb-3">
            <select class="form-select" id="floatingSelectTrangThai" aria-label="Floating label select example" name="trangThai" value="${data.trangThai}">
        ...
        <div class="mb-3">
            ...
            <a href="/san-pham-chi-tiet/index">

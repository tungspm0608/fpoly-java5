...
<div class="container mt-5 pt-5">
    ...
    <div class="row mt-2 mb-2">
        <div class="col-8">
            <a href="/khach-hang/create"><button type="button" class="btn btn-primary">Thêm</button></a>
        </div>
...
<table class="table">
    ...
    <c:forEach items="${data}" var="sp">
        <tr>
            ...
            <td>${sp.sdt}</td>
            <td>${sp.maKh}</td>
            <td>${sp.trangThai == 1 ? "Còn Hoạt Động" : "Ngừng Hoạt Động"}</td>
            <td>
                <a href="/khach-hang/edit/${sp.id}"><button type="button" class="btn btn-info">Sửa</button></a>
                <a href="/khach-hang/delete/${sp.id}"><button type="button" class="btn btn-danger">Xóa</button></a>
            </td>
        </tr>

...
<div class="container mt-5 pt-5">
    <h1 class="text-center">Sửa Kích Thước</h1>
    <form action="/kickthuoc/update/${data.id}" method="post">
        ...
        <div class="form-floating mb-3">
            <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="trangThai" value="${data.trangThai}">
                <option value="0" ${data.trangThai == 0? "selected" : ""}>Không Còn Bán</option>
                <option value="1" ${data.trangThai == 1? "selected" : ""}>Còn Bán</option>
            </select>
        ...
        <div class="mb-3">
            ...
            <a href="/kichthuoc/index"><button type="button" class="btn btn-light">Back</button></a>
        </div>
    </form>
</div>
</body>

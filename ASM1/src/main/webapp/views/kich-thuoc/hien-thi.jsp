...
<div class="container mt-5 pt-5">
    ...
    <div class="row mt-2 mb-2">
        <div class="col-8">
            <a href="/kich-thuoc/create"><button type="button" class="btn btn-primary">Thêm</button></a>
        </div>
    ...
    <table class="table">
        ...
        <c:forEach items="${data}" var="sp">
            <tr>
                ...
                <td>${sp.ma}</td>
                <td>${sp.ten}</td>
                <td>${sp.trangThai == 1 ? "Còn Bán" : "Không Còn Bán"}</td>
                <td>
                    <a href="/kichthuoc/edit/${sp.id}"><button type="button" class="btn btn-info">Sửa</button></a>
                    <a href="/kichthuoc/delete/${sp.id}"><button type="button" class="btn btn-danger">Xóa</button></a>
                </td>
            </tr>
